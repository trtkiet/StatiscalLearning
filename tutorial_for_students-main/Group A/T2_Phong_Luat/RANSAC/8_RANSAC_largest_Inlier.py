    ...
    def fit(self, X, y):
        ...
        while num_iteration < self.k:
            ...
            if len(inlier) > self.d:
                ...
                if len(inlier) == len(self.best_inliers) and this_error < self.best_error:
                    # accept_inliets_set is the consensus set where its size is equal to the best_inliers set
